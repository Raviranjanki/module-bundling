...
exports.jokeContainer = exports.button = void 0;
var jokeContainer = document.querySelector(".joke p");
...
function fetchJokes(_x) {
  return _fetchJokes.apply(this, arguments);
}

function _fetchJokes() {
  _fetchJokes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
    var response;
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _elements.button.addEventListener("click", _handleClick.default);
